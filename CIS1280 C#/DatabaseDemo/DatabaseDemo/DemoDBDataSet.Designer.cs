...
namespace DatabaseDemo.DemoDBDataSetTableAdapters {
...
SELECT pkDogID, breed, color, age, sex, weight, birthday FROM tblDog WHERE (pkDogID = @pkDogID)";
        ...
        public virtual int Fill(DemoDBDataSet.tblDogDataTable dataTable) {
        ...
        public virtual DemoDBDataSet.tblDogDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DemoDBDataSet.tblDogDataTable dataTable = new DemoDBDataSet.tblDogDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DemoDBDataSet.tblDogDataTable dataTable) {
