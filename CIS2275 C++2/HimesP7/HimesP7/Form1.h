...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(289, 350);
			...
			// richTextBoxSummary
			// 
			this->richTextBoxSummary->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14.25F, System::Drawing::FontStyle::Regular, 
			...
			this->richTextBoxSummary->Size = System::Drawing::Size(662, 96);
			 ...
			 if (textBoxMessage->Text == "") {
				...
				MessageBox::Show(noMsgError);
				 ...
				 if (radioEnterKey->Checked) {
					 ...
					 enigma.SetMessage(message);//random number 1-50 is generated and assigned to enigma's key
					 key = enigma.GetKey();
				 ...
				 ssSummary << "Message: \"" << enigma.GetDecodedMessage() << "\"" << endl;
				 ssSummary << "Encoded Message: \"" << enigma.GetCodedMessage() << "\"" << endl;
				 ssSummary << "Key: " << key;//key was assigned a value from whichever radio button selection.
				 ...
				 if (saveFileDialog1->ShowDialog()==System::Windows::Forms::DialogResult::OK) {
					...
					output->WriteLine(gcnew String(enigma.GetCodedMessage().c_str()));
					output->WriteLine(enigma.GetKey().ToString());
					output->Close();
